...
const AddDocumentModal: React.FC<AddDocumentModalProps> = ({ onClose, onSubmit, isLoading }) => {
              ...
              {!file ? (
                <>
                  ...
                  <input
                    ...
                    style={{ display: 'none' }}
                  />
                  <p className="file-info">Supported formats: PDF, DOC, DOCX, JPG, PNG, XLS, XLSX (Max 10MB)</p>
                </>
              ) : (
